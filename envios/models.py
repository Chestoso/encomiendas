...
class Encomienda(models.Model):
    ...
    def clean(self):
        """Valida reglas que involucran más de un campo a la vez."""
        errors = {}
        ...
        # Regla 3: fecha real no puede ser antes que la estimada
    ...
    def calcular_costo(self):
        """
        Calcula el costo basándose en precio base de la ruta y el peso.
        Primeros 5 kg incluidos en precio base.
        Cada kg adicional cuesta S/. 2.50.
        """
    ...
    def cambiar_estado(self, nuevo_estado, empleado, observacion=''):
        ...
        if nuevo_estado == self.estado:
            raise ValueError(
                f'La encomienda ya está en estado '
        ...
        Encomienda.objects.filter(pk=self.pk).update(
            estado=self.estado,
            fecha_entrega_real=self.fecha_entrega_real
        )
    ...
    def crear_con_costo_calculado(
        cls, remitente, destinatario, ruta,
